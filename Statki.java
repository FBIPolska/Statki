...
public class Statki {
    ...
    private int rozmiar = 7; // Rozmiar planszy
    private int statki = 4; // Liczba statków
    ...
    public static void main(String[] args) 
    {
        ...
        while (trafioneGracza < 4 && trafioneKomputera < 4) 
        {
            // Ruch gracza
            ...
            {
                System.out.println("Gdzie strzelasz plansza jest gdzie indziej");
